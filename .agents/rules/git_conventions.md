...
- Scope should refer to the Unit or Project (e.g.,
  `feat(04_ShoppingList): ...`).
...
4. `git push origin main:main`: Direct pushes to main are allowed for
   educational units, but verify stability first.
...
- **Background Processes**: Ensure no `dotnet` or `tailwindcss` processes are
